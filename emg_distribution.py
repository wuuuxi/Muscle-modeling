...
def emg_file_progressing(emg, fs=1000, people=None, sport='biceps_curl'):
    if sport == 'biceps_curl':
        ...
        emg_rect_label = ['TA', 'GasLat', 'GasMed', 'VL', 'RF', 'VM', 'TFL', 'AddLong', 'Sem', 'BF',
                          'GMax', 'GMed', 'PsoMaj', 'IO', 'RA', 'ESI', 'Mul', 'EO']
        emg_list = []
        t_list = []
        for i in range(len(emg_rect_label)):
            [emg_rect, t] = emg_rectification(emg[:, i + 1], fs, emg_rect_label[i], people, left)
...
#     fs = 1000
#     num = 0
#     if label == 'yt-bp-20kg' and date == '240408':
#         rep = 10
...
#         ]
#     elif label == 'yt-bp-30kg' and date == '240408':
#         rep = 8
...
#         ]
#     elif label == 'yt-bp-40kg' and date == '240408':
#         rep = 8
#         file_folder = 'files/bench press/yuetian/0408/Test EMG/'
...
#         ]
#     elif label == 'yt-bp-50kg' and date == '240408':
#         rep = 8
#         file_folder = 'files/bench press/yuetian/0408/Test EMG/'
...
#         ]
#     elif label == 'yt-bp-60kg' and date == '240408':
#         rep = 10
#         file_folder = 'files/bench press/yuetian/0408/Test EMG/'
...
#         ]
#     elif label == 'yt-bp-all' and date == '240408':
#         rep1 = 10
#         rep2 = 8
#         rep3 = 8
#         rep4 = 8
...
#             [29.015, 30.048, 30.048, 30.982]
#         ]
#     elif label == 'yt-bp-20kg' and date == '240604':
#         rep = 10
...
#         ]
#     elif label == 'yt-bp-30kg' and date == '240604':
#         rep = 10
#         file_folder = 'files/bench press/muscle-18/yuetian/emg/'
...
#         ]
#     elif label == 'yt-bp-40kg' and date == '240604':
#         rep = 10
#         file_folder = 'files/bench press/muscle-18/yuetian/emg/'
...
#         ]
#     elif label == 'yt-bp-50kg' and date == '240604':
#         rep = 10
#         file_folder = 'files/bench press/muscle-18/yuetian/emg/'
...
#         ]
#     elif label == 'yt-bp-60kg' and date == '240604':
#         rep = 10
#         file_folder = 'files/bench press/muscle-18/yuetian/emg/'
...
#         ]
#     elif label == 'yt-bp-all' and date == '240604':
#         rep = [10] * 5
#         file_folder = 'files/bench press/muscle-18/yuetian/emg/'
...
#         ]
#     elif label == 'yg-sq-70kg':
#         rep = 9
#         file_folder = 'files/squat/yangguo/emg/'
#         files = [file_folder + 'test 2024_08_07 18_45_10.csv'] * rep
#         sport_label = 'squat'
#         people = 'yangguo'
#         t_delta_emg = [0] * rep
#         t_delta_joi = [0] * rep
#         timestep_emg = [
#             [16.533, 17.783, 17.783, 18.666],
#             [19.616, 20.949, 20.949, 21.932],
#             [22.749, 24.016, 24.016, 24.966],
#             [25.782, 26.982, 26.982, 27.816],
#             [28.632, 29.899, 29.899, 30.849],
#             [31.632, 33.032, 33.032, 33.882],
#             [34.665, 35.865, 35.865, 36.915],
#             [37.848, 38.932, 38.932, 39.865],
#             [40.582, 41.898, 41.898, 42.998]
#         ]
#     else:
#         print('No label:', label)
#         return 0
...
#         t_emg_all[i] = t_emg_all[i] - t_delta_emg[i] + t_delta_joi[i]
#
#     if sport_label == 'bench_press' or sport_label == 'deadlift' or sport_label == 'squat':
#         muscles = [[([]) for _ in range(len(measured_muscle_idx))] for _ in range(data_set_number)]  # number of muscle
#     for k in range(data_set_number):
#         for j in range(len(measured_muscle_idx)):
#             for i in range(int(len(timestep_emg[k]) / 2)):
...
#         for j in range(len(measured_muscle_idx)):
#             plt.subplot(math.ceil(len(measured_muscle_idx) / 2), 2, j + 1)
#             for i in range(data.shape[1]):
#                 plt.plot(data[j, i, :], color=color[i % len(color)])
#             plt.ylabel(musc_label[j], weight='bold')
#             if j != len(measured_muscle_idx) - 1:
...
if __name__ == '__main__':
    ...
    calculate_other_emg_distribution(label='yg-sq-70kg')
